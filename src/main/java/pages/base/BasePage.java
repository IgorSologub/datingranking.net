...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='nH2e6W0']");
    private final By headerMenuOpen = By.xpath("//button[@class='wO-PIYX172p js-modal-btn']");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='GWKzg2k4-_ '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerMenuOpen () {
        By headerButton = By.xpath("(//a[@class='GWKzg2k4-_ '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='oS3GP0oO'])[" + numButton + "]");
